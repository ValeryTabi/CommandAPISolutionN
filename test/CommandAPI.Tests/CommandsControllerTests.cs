...
namespace CommandAPI.Tests
{
  public class CommandsControllerTests : IDisposable
  {
        ...
        //var controller = new CommandsController( /* repository, AutoMapper */);var result = controller.GetAllCommands();
    ...
    //Act
        ...
        {
            //Arrange
            mockRepo.Setup(repo => repo.GetCommandById(It.IsAny<Int32>())).Returns(new Command { Id = 1,
                HowTo = "mock",
                Platform = "Mock",
                CommandLine = "Mock" });
                var controller = new CommandsController(mockRepo.Object, mapper);
